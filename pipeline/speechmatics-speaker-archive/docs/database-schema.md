...
Полный путь от reference WAV до этих таблиц, состояния очереди и правила
восстановления описаны в
[`Speechmatics-пайплайн: полное руководство`](../../../docs/speechmatics-pipeline.md).
